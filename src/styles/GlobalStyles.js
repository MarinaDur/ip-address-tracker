...
--color-very-dark-gray:0 0% 17%;
--color-neutral-off-black:0 0% 25%;
--color-dark-gray: 0 0% 59%;
--color-white: 0 0% 100%;
--color-blue: 221 61% 50%;
...
/* --color-neutral-off-black: hsl(0, 0%, 20%); */
...
.leaflet-touch .leaflet-control-layers, .leaflet-touch .leaflet-bar {
  ...
  .leaflet-container .leaflet-control-zoom-in:hover,
          .leaflet-container .leaflet-control-zoom-out:hover  {
     background: hsl(var(--color-blue)/.8);
}    
